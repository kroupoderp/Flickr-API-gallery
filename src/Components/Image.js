...
let mobileDetectionRegex = /Android|webOS|iPhone|iPad|BlackBerry|Windows Phone|Opera Mini|IEMobile|Mobile/i
...
class Image extends React.Component {
  ...
  componentDidUpdate() {
    // lifecycle method appears to run when tapping on an image on mobile
    if (this.state.hovering && !mobileDetectionRegex.test(navigator.userAgent)) {
  ...
  render() {
    ...
    if (!mobileDetectionRegex.test(navigator.userAgent)) {
      return (
        <div ref={(el) => {this.container = el}} className="overlayContainer" onMouseOver={this.hoverHandler} onMouseLeave={this.handleLeave} style={this.props.styles}>
          <img onLoad={this.props.onLoader} src={this.props.photo_url} alt=""/>
            {this.state.hovering ? 
              <a href={this.props.origin} ref={(el) => {this.overlay = el}} className="overlay">
      ...
      return (
        <a href={this.props.origin} style={this.props.styles} >
          <img onLoad={this.props.onLoader} src={this.props.photo_url} alt=""/>
        </a>
      )
    }
